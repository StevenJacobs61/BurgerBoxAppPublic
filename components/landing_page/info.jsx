...
const Info = ({sections, settings, complete}) => {
  ...
  return (
    ...
    <p className={styles.notice}>This is test version for the purpose of showcase. User cannot write in db. Please browse the features: Create orders, Pay via Stripe API, RealTime notifications with socket.io, Manage discount tokens, Menu items and Settings. Admin username = "a", Admin password = "a". Live app URL https://www.burgerbox-uk.com. The food is great!</p>
    </div>
    : null}
